import CANNON from "https://unpkg.com/three@0.119.1/examples/jsm/physics/../libs/cannon.module.min.js";
...
function CannonPhysics() {
  ...
  function handleGroup( mesh, mass ) {
    ...
    //iterate through children and add them to the body
    for(var i=0;i<mesh.children.length;i++){      
      var m = mesh.children[i];
      var shape = getShape(m.geometry);
      ...
      var subSphere = new CANNON.Sphere(m.geometry.parameters.radius);
      body.addShape(subSphere, p, q);
    }
		world.addBody( body );
	...
	function setMeshQuaternion( mesh, quaternion, index = 0 ) {
  ...
  function stopMesh(mesh){
    ...
    stopMesh: stopMesh,
    setMeshQuaternion: setMeshQuaternion
		// addCompoundMesh
	};
