import {
	Object3D
} from 'https://unpkg.com/three@0.119.1/examples/jsm/webxr/../../../build/three.module.js';

import {
	XRHandPrimitiveModel
} from 'https://unpkg.com/three@0.119.1/examples/jsm/webxr/XRHandPrimitiveModel.js';
...
const XRHandModelFactory = ( function () {
	...
	XRHandModelFactory.prototype = {
		...
		createHandModel: function ( controller, profile, options, callback ) {
			...
			controller.addEventListener( 'connected', ( event ) => {
				...
				if ( xrInputSource.hand && ! handModel.motionController ) {
					...
					if ( profile === undefined || profile === 'spheres' ) {
						...
						handModel.motionController = new XRHandOculusMeshModel( handModel, controller, this.path, xrInputSource.handedness, options, callback );
